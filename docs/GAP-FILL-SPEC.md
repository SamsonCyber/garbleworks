...
| Field | Spec |
|-------|------|
| **Problem** | Many techniques x targets -> false discovery. EVOLVE_MATH sec 14 specifies BH-FDR; not a default production gate (CHANGELOG / GAPS). Positioning still says "BH-FDR-grade" in places; wire or soft-claim. |
...
|----------|--------------|
| Full interactive TUI... | sec 1 closed v0.1 + G8 residual |
...
Peer section: sec 3. Phases: sec 4. Closed not reopened: sec 1.
