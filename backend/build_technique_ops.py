...
OP_TO_TECH = {
    ...
    "multilang": "Multilingual / low-resource pivot",
    "low_resource_pivot": "Multilingual / low-resource pivot",
    "nested_lang": "Multilingual / low-resource pivot",
    "answer_in_lang": "Multilingual / low-resource pivot",
    "code_switch": "Cross-lingual code-switching",
    "script_mix": "Runic & Alternate-Script Substitution",
    "romanization_frame": "Runic & Alternate-Script Substitution",
    "amazigh_obfuscate": "Amazigh / Tifinagh low-resource",
    ...
    # 2026-08 gap ship
    "red_queen_frame": "Red Queen Attack",
    "industry_reframe": "Legitimate industry reframing",
    "stac_chain": "STAC (Sequential Tool Attack Chaining)",
    "tag_along_seed": "Tag-Along Attacks",
    "conjunctive_split": "Conjunctive Prompt Attacks",
    "mastermind_seed": "Mastermind (knowledge-driven",
    "x_teaming_seed": "X-Teaming",
    "overthinking_frame": "Overthinking (extra reasoning",
    "agent_only_perceptual": "Agent-only perceptual injection",
    # 2026-08 gap ship v2
    "slip_lexical_insert": "SLIP (Self-Jailbreaking via Lexical Insertion",
    "cot_puzzle_hijack": "CoT Hijacking (prolonged benign puzzle",
    "smt_moderation_trace": "SMT (Simulated Moderation Traces",
    "jaws_workspace_seed": "JAWS (Jailbreaks Across WorkSpaces",
    "s2c_stack": "S2C (Structured Semantic Cloaking)",
    "hill_learning_frame": "HILL (Hiding Intention by Learning",
    "agent_decompose_combine": "Agent-driven multi-turn decomposition",
    "contextual_jailbreak_seed": "ContextualJailbreak (evolutionary",
    "odysseus_seed": "Odysseus (dual steganography",
    # prose
    ...
    "role_slip_delimiter": "Role-slip delimiter (Opus 5",
